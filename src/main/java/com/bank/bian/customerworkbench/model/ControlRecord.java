package com.bank.bian.customerworkbench.model;
...
/**
 * The BIAN control record for this service domain: "Servicing Session Operating Session".
 *
 ...
 * to its asset type (Servicing Session). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Servicing Session Operating Session";
